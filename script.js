...
const numInRatioForExp = 2; // число для соотношения: если отростков меньше [кол-во всех клеток] / (это число) для экспов
const numInRatioForQua = 2; // число для соотношения: если отростков меньше [кол-во всех клеток] / (это число) для качественников
const numInRatioForNom = 2; // число для соотношения: если отростков меньше [кол-во всех клеток] / (это число) для кочевников
