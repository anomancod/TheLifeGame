...
const numInRatioForExp = 10; // число для соотношения: если отростков меньше [кол-во всех клеток] / (это число) для экспов
const numInRatioForQua = 10; // число для соотношения: если отростков меньше [кол-во всех клеток] / (это число) для качественников
const numInRatioForNom = 10; // число для соотношения: если отростков меньше [кол-во всех клеток] / (это число) для кочевников
