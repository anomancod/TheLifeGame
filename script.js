...
const numInRatioForExp = 7; // число для соотношения: если отростков (с пустыми клетками вокруг) меньше [кол-во всех клеток] / (это число) для экспов
const numInRatioForQua = 7; // число для соотношения: если отростков (с пустыми клетками вокруг) меньше [кол-во всех клеток] / (это число) для качественников
const numInRatioForNom = 7; // число для соотношения: если отростков (с пустыми клетками вокруг) меньше [кол-во всех клеток] / (это число) для кочевников
