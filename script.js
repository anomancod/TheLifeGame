...
const numInRatioForExp = 5; // число для соотношения: если отростков меньше [кол-во всех клеток] / (это число) для экспов
const numInRatioForQua = 5; // число для соотношения: если отростков меньше [кол-во всех клеток] / (это число) для качественников
const numInRatioForNom = 5; // число для соотношения: если отростков меньше [кол-во всех клеток] / (это число) для кочевников
