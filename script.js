...
const numInRatioForExp = 20; // число для соотношения: если отростков (с пустыми клетками вокруг) меньше [кол-во всех клеток] / (это число) для экспов
const numInRatioForQua = 15; // число для соотношения: если отростков (с пустыми клетками вокруг) меньше [кол-во всех клеток] / (это число) для качественников
